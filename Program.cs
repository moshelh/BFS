...
namespace BFS
{
    ...
    {
        //The code return an IEnumerable<T>, which provides all the vertices that make up the shortest path to get from the starting vertex to the destination vertex. 
